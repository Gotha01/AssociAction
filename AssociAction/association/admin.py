...
class AssociationAdmin(admin.ModelAdmin):
    list_display = ('id', 'associationname', 'acronym', 'phone_number', 'email', 'description')
    list_display_links = ('id', 'associationname')
    search_fields = ('associationname', 'acronym', 'phone_number', 'email', 'description')
    list_per_page = 25

class SectorAdmin(admin.ModelAdmin):
    list_display = ('sectorname','description')
...
class UserRoleAssociationAdmin(admin.ModelAdmin):
    ...
    list_display_links = ('user', 'association', 'role')
    list_filter = ('association', 'role')
    search_fields = ('user__first_name', 'user__last_name', 'user__email', 'association__associationname', 'role__rolename')
    list_per_page = 25

class AssociationSectorAdmin(admin.ModelAdmin):
    list_display = ('association', 'sector')
    list_display_links = ('association', 'sector')
    list_filter = ('association', 'sector')
