    ...
    sectors = [
        {
            ...
            "description": "Promotion des arts visuels, de la musique,"
            " de la danse, etc."
        },
        {
        ...
        {
            "sectorname": "Santé",
            "description": "Vaccinations, accès aux soins médicaux,"
        ...
        },
        {
            ...
            "description": "Développement durable, protection de"
            " l'environnement, etc."
        },
        {
            "sectorname": "Vie sociale",
            "description": "Personnes âgées, jeunesse et loisirs,"
            " découverte sociale"
        },
        {
        ...
        },
        {
            ...
            "description": "Préservation du patrimoine culturel,"
        ...
        },
        {
            ...
            "description": "Agriculture durable, coopératives,"
            " sécurité alimentaire, etc."
        },
        {
            "sectorname": "Tourisme",
            "description": "Promotion du tourisme local,"
        ...
        roles = [
            {
                ...
                "- Donner/enlever les droits administrateur à"
                " un membre de l'association\n"
                "- Possède les droits administrateurs de l'association",
            },
            {
                "rolename": "Admin",
                "description": "Administrateur d'association.\n"
                "- Il peut donner/enlever les droits de membre à"
